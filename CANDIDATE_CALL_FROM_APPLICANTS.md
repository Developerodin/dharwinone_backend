...
- [CANDIDATE_VERIFICATION_CALL_SYSTEM.md](./CANDIDATE_VERIFICATION_CALL_SYSTEM.md) - Overall candidate verification system
- [SEPARATE_WEBHOOKS.md](./SEPARATE_WEBHOOKS.md) - Webhook configuration details
- [BOLNA_MULTI_AGENT_SETUP.md](./BOLNA_MULTI_AGENT_SETUP.md) - Multi-agent setup guide

...
- **Fork the repo**
- **Clone the repo** and set it up (see the root [README.md](../README.md) and [docs/README.md](./README.md))
...
Some other ESLint plugins are also being used, such as the [Prettier](https://github.com/prettier/eslint-plugin-prettier) plugin.

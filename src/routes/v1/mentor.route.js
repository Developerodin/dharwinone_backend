...
router
  ...
  .post(auth(), requirePermissions('mentors.manage'), upload.single('file'), mentorController.uploadProfileImage)
...
router
  ...
  .patch(
    ...
    validate(mentorValidation.updateMentor),
    mentorController.updateMentor
  )
  .delete(
    auth(),
    requirePermissions('mentors.manage'),
    validate(mentorValidation.deleteMentor),

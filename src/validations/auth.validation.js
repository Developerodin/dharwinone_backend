...
const updateMeWithCandidate = {
  body: Joi.object()
    .keys({
      ...
      eadCardNumber: Joi.string().allow('', null),
      eadValidFrom: Joi.date().allow(null).optional(),
      eadValidTo: Joi.date().allow(null).optional(),
      visaNumber: Joi.string().allow('', null),
      visaIssueDate: Joi.date().allow(null).optional(),
      visaExpiryDate: Joi.date().allow(null).optional(),
